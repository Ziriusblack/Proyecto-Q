...
public class ReportDTO {
    ...
    public ReportDTO(
            String id, Date fecha, String nombres, String apellidos, String descripcion,
    ...
    public static ReportDTO fromEntity(Queja queja) {
        ReportDTO dto = new ReportDTO();
        dto.setFecha(queja.getFecha());
        dto.setDescripcion(queja.getDescripcion());
        dto.setTipoQueja(queja.getTipoQueja());
        dto.setUbicacion(queja.getUbicacion());
        dto.setEstado(queja.getEstado());
        dto.setRespuesta(queja.getRespuesta());
        return dto;
    }
